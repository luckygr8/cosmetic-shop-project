 ...
 */
public class View_brand extends javax.swing.JInternalFrame {

    /**
     * Creates new form View_brand
     */
    public View_brand() {
        initComponents();
        setSize(800, 500);
    ...
    private void deleteRecord() {
        if (srow != -1 && allcategories != null && srow < allcategories.size()) {
            ...
            if (result == JOptionPane.YES_OPTION) {
                Brandinfo_TO ci = allcategories.get(srow);
                Brandinfo_DAO action = new Brandinfo_DAO();
                String message = "";
                if (action.deleterecord(ci.getBrandid())) {
    ...
    private void editRecord() {
        if (srow != -1 && allcategories != null && srow < allcategories.size()) {
            Checks.openInternalFrame(Mainscreen.getDeskpane(), new Input_brand(2));
            dispose();
        }
    }
...
@SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jLabel1.setText("View All Bands");
...
dispose();
    ...
    private List<Brandinfo_TO> allcategories;
    private int srow;
    private JPopupMenu popup;
    public void bindTableDetails() {
        allcategories = new Brandinfo_DAO().getallrecords();
        String[] col_names = {"Brand ID", "Brand Name"};
        Object[][] records = null;
        if (allcategories != null && allcategories.size() > 0) {
            records = new Object[allcategories.size()][col_names.length];
            int i = 0;
            for (Brandinfo_TO ct : allcategories) {
                records[i] = new Object[]{ct.getBrandid(), ct.getBrandname()};
                i++;
            }
        } else {
